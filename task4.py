...
We should print up to fivefirst found elements.
"""
car_data = {
...
sorted_price = sorted(car_data.values(), key=lambda x_value: x_value[4])
for it in sorted_price[:5]:
    print((it[1], it[2], it[4]))